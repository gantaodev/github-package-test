package com.zd.core.parser.xml;

import com.zd.core.parser.property.PropertyParser;
...
public class XNode {
    ...
    public Properties getChildrenAsProperties(String nameKey, String valueKey) {
        Properties properties = new Properties();
        for (XNode child : getChildren()) {
            String name = child.getStringAttribute(nameKey);
            String value = child.getStringAttribute(valueKey);
            if (name != null && value != null) {
                properties.setProperty(name, value);
            }
        }
