...
public class BOMInputStream extends InputStream {
    ...
    public BOMInputStream(InputStream in) {
        this(in, StandardCharsets.UTF_8.name());
    }
     ...
     * @param init 初始化
     */
    public BOMInputStream(InputStream in, boolean init) throws IOException {
        this(in, StandardCharsets.UTF_8.name(), init);
    }
     ...
     * @param init 初始化
     */
    public BOMInputStream(InputStream in, String defaultCharset, boolean init) throws IOException {
        this.in = new PushbackInputStream(in, BOM_SIZE);
        this.defaultCharset = defaultCharset;
        if (init) {
            init();
